...
"""
    ...
    def get_swap_price(self, **params):
        #added by Takumi
        #params = quoteAsset, baseAsset, quoteQty < 5000
        return self._request_margin_api('get', 'bswap/quote', True, data=params)

    def add_liquidity(self,**params):
        #added by Takumi
        #params = poolId, asset, quantity
        return self._request_margin_api('get', 'bswap/liquidityAdd', True, data=params)
    
    def remove_liquidity(self,**params):
        #added by Takumi
        #params = poolId, type = "SINGLE" or "COMBINATION", asset =["coinname1","coinname2"],shareAmount < half of amount
        return self._request_margin_api('get', 'bswap/liquidityRemove', True, data=params)
